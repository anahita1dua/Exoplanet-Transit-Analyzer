...
#we may need to install autograd oktopus for the curve to work properly
...
print("Finding consecutive transit points.....")
groups=[]
transit=[]
...
print("The consecutive transit indices are: ", groups)
	
print(f"Consecutive transit points' groups found: {len(groups)}")
...
#transit depth
print("Calculating transit depth.....")
depth = 1 - np.min(flux)
print(f"Transit Depth: {depth*100:.3f}%")

#radius
print("Calculating planet radius.....")
...
print("NOTE: These are just the estimates not the actual values. For more accurate results, please refer to the scientific literature.")

#Graph
print("Making graph for possible transit indices.....")
